...
LDLIBSOPTIONS=-L/usr/lib/i386-linux-gnu -lmysqlclient -lpthread -lz -lm -lrt -ldl -lz -I/usr/include/mysql -DBIG_JOINS=1 -fno-strict-aliasing -g

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ttserver

ttserver: ${OBJECTFILES}
	${LINK.c} -o ttserver ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/communicator.o: communicator.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/communicator.o communicator.c
